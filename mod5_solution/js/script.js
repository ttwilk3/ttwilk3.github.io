...
dc.loadAbout = function () {
  ...
  $ajaxUtils.sendGetRequest(
        ...
        function (aboutHtml) {
          ...
          let howMany = getRandomRating();
          let empty = "fa fa-star-o";
          let full = "fa fa-star";

          for (var i = 0; i < 5; i++) {
            // console.log("class" + (i + 1));
            if (i < howMany) {
              aboutHtml = insertProperty(aboutHtml, "class" + (i + 1), full);
            } else {
              aboutHtml = insertProperty(aboutHtml, "class" + (i + 1), empty);
            }
          }
          insertHtml("#main-content", aboutHtml);

          /*var html = "<span>";
          html += howMany + "-star rating!!!";
          html += "</span>";*/
          let starRatingHtml = howMany + "-star rating!!!";
          insertHtml("#rating-value", starRatingHtml);
          
          // This is the Jquery way
          /*let stars = $('#about').find('span').each(function(i, obj) {
            if (i < howMany) {
